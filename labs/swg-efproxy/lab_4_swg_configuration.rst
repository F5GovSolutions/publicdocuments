...
---------------------------------
    ...
    #. In the **Security Policy** page, click the pencil icon to edit the **All** policy. 

        .. image:: ./images/l-sslo-security-policy-1.png
            :align: center
            :alt: SSLO Security Policy

        In the policy editor, click the **Service Chain** dropdown and select the service chain we  created, **ssloSC_swg_poc** to link the service chain to the policy. Click the **OK** button to save the policy, then click the **Save & Next** button to continue.

        .. image:: ./images/l-sslo-security-policy-2.png
            :align: center
            :alt: SSLO Security Policy Edit
