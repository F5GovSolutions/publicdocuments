...
This will be an overview of the SWG Reports dashboard and the various metrics and charts available to monitor the SWG activity. Customization of the dashboard and the individual widgets are outside the scope of this lab.
    ...
    #. In to the **BIG-IP SSLO-1 TMUI**, navigate to **Access > Overview > SWG Reports > Overview**
    ...
    #. Using the top navigation bar, select **SWG Reports > All Requests** and review the information provided.

    #. Using the top navigation bar, select **SWG Reports > Blocked Requests** and review the information provided.

Task 2. Viewing SWG Event Logs
------------------------------

    #. In to the **BIG-IP SSLO-1 TMUI**, navigate to **Access > Overview > SWG Reports > URL Request Logs**
